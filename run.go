...
import (
	...
	ovhscheme "kubeform.dev/provider-ovh-api/client/clientset/versioned/scheme"
...
func init() {
	_ = ovhscheme.AddToScheme(scheme)
...
func NewCmdRun(version string) *cobra.Command {
	cmd := &cobra.Command{
		Use:               "run",
		Short:             "Launch Kubeform ovh Provider controller",
		DisableAutoGenTag: true,
		Run: func(cmd *cobra.Command, args []string) {
			klog.Infoln("Starting provider-ovh-controller...")
			...
			mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
				...
				LeaderElectionID:       "ovh.kubeform.com",
			})
			if err != nil {
