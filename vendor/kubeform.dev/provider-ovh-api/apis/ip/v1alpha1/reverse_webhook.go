...
var reverseForceNewList = map[string]bool{
	"/ip":         true,
	"/ip_reverse": true,
	"/reverse":    true,
}
...
func (r *Reverse) ValidateUpdate(old runtime.Object) error {
	...
	for key, _ := range reverseForceNewList {
		...
		if checkIfAnyDif && r.Spec.UpdatePolicy == base.UpdatePolicyDoNotDestroy {
			return fmt.Errorf(`reverse "%v/%v" immutable field can't be updated. To update, change spec.updatePolicy to Destroy`, r.Namespace, r.Name)
		}
	}
	return nil
}
