...
func (in *HttpRouteSpecResource) DeepCopyInto(out *HttpRouteSpecResource) {
	*out = *in
	...
	if in.Rules != nil {
		...
		*out = make([]HttpRouteSpecRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TcpRouteRuleSpec) DeepCopyInto(out *TcpRouteRuleSpec) {
	*out = *in
	if in.State != nil {
		in, out := &in.State, &out.State
		*out = new(TcpRouteRuleSpecResource)
		(*in).DeepCopyInto(*out)
	}
	in.Resource.DeepCopyInto(&out.Resource)
	out.ProviderRef = in.ProviderRef
...
func (in *TcpRouteRuleSpecResource) DeepCopy() *TcpRouteRuleSpecResource {
	if in == nil {
		return nil
	}
	out := new(TcpRouteRuleSpecResource)
...
func (in *TcpRouteSpecResource) DeepCopyInto(out *TcpRouteSpecResource) {
	*out = *in
	...
	if in.Rules != nil {
		in, out := &in.Rules, &out.Rules
		*out = make([]TcpRouteSpecRules, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TcpRouteSpecResource) DeepCopy() *TcpRouteSpecResource {
	if in == nil {
		return nil
	}
	out := new(TcpRouteSpecResource)
