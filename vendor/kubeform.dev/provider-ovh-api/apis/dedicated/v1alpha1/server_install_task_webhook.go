...
//+kubebuilder:webhook:verbs=create;update;delete,path=/validate-dedicated-ovh-kubeform-com-v1alpha1-serverinstalltask,mutating=false,failurePolicy=fail,groups=dedicated.ovh.kubeform.com,resources=serverinstalltasks,versions=v1alpha1,name=serverinstalltask.dedicated.ovh.kubeform.io,sideEffects=None,admissionReviewVersions=v1
...
func (r *ServerInstallTask) ValidateDelete() error {
	if r.Spec.TerminationPolicy == base.TerminationPolicyDoNotTerminate {
		return fmt.Errorf(`serverinstalltask "%v/%v" can't be terminated. To delete, change spec.terminationPolicy to Delete`, r.Namespace, r.Name)
	}
	return nil
}
