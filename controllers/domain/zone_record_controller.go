...
// +kubebuilder:rbac:groups=domain.ovh.kubeform.com,resources=zonerecords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=domain.ovh.kubeform.com,resources=zonerecords/status,verbs=get;update;patch
...
func (r *ZoneRecordReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &domainv1alpha1.ZoneRecord{}); err != nil {
			klog.Error(err, "unable to set up auditor", domainv1alpha1.ZoneRecord{}.APIVersion, domainv1alpha1.ZoneRecord{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&domainv1alpha1.ZoneRecord{}).
