...
// +kubebuilder:rbac:groups=cloud.ovh.kubeform.com,resources=projects,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloud.ovh.kubeform.com,resources=projects/status,verbs=get;update;patch
...
func (r *ProjectReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &cloudv1alpha1.Project{}); err != nil {
			klog.Error(err, "unable to set up auditor", cloudv1alpha1.Project{}.APIVersion, cloudv1alpha1.Project{}.Kind)
			return err
		}
	}
