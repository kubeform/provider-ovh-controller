...
// +kubebuilder:rbac:groups=vrack.ovh.kubeform.com,resources=ips,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vrack.ovh.kubeform.com,resources=ips/status,verbs=get;update;patch
...
func (r *IpReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vrackv1alpha1.Ip{}); err != nil {
			klog.Error(err, "unable to set up auditor", vrackv1alpha1.Ip{}.APIVersion, vrackv1alpha1.Ip{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vrackv1alpha1.Ip{}).
