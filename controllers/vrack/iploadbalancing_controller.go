...
// +kubebuilder:rbac:groups=vrack.ovh.kubeform.com,resources=iploadbalancings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=vrack.ovh.kubeform.com,resources=iploadbalancings/status,verbs=get;update;patch
...
func (r *IploadbalancingReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &vrackv1alpha1.Iploadbalancing{}); err != nil {
			klog.Error(err, "unable to set up auditor", vrackv1alpha1.Iploadbalancing{}.APIVersion, vrackv1alpha1.Iploadbalancing{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&vrackv1alpha1.Iploadbalancing{}).
