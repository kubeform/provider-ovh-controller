...
// +kubebuilder:rbac:groups=iploadbalancing.ovh.kubeform.com,resources=httproutes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=iploadbalancing.ovh.kubeform.com,resources=httproutes/status,verbs=get;update;patch
...
func (r *HttpRouteReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &iploadbalancingv1alpha1.HttpRoute{}); err != nil {
			klog.Error(err, "unable to set up auditor", iploadbalancingv1alpha1.HttpRoute{}.APIVersion, iploadbalancingv1alpha1.HttpRoute{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&iploadbalancingv1alpha1.HttpRoute{}).
