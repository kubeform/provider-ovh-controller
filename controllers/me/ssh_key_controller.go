...
// +kubebuilder:rbac:groups=me.ovh.kubeform.com,resources=sshkeys,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=me.ovh.kubeform.com,resources=sshkeys/status,verbs=get;update;patch
...
func (r *SshKeyReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher, restrictToNamespace string) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &mev1alpha1.SshKey{}); err != nil {
			klog.Error(err, "unable to set up auditor", mev1alpha1.SshKey{}.APIVersion, mev1alpha1.SshKey{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&mev1alpha1.SshKey{}).
