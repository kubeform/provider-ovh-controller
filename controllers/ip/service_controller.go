...
// +kubebuilder:rbac:groups=ip.ovh.kubeform.com,resources=services,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ip.ovh.kubeform.com,resources=services/status,verbs=get;update;patch
...
func (r *ServiceReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager, auditor *auditlib.EventPublisher) error {
	if auditor != nil {
		if err := auditor.SetupWithManager(ctx, mgr, &ipv1alpha1.Service{}); err != nil {
			klog.Error(err, "unable to set up auditor", ipv1alpha1.Service{}.APIVersion, ipv1alpha1.Service{}.Kind)
			return err
		}
	}

	return ctrl.NewControllerManagedBy(mgr).
		For(&ipv1alpha1.Service{}).
